...
const oauth_ink = 'https://developers.google.com/oauthplayground';

const { EMAIL, CLIENT_ID, CLIENT_SECRET, CLIENT_REFRESH } = process.env;

const auth = new OAuth2(CLIENT_ID, CLIENT_SECRET, CLIENT_REFRESH, oauth_ink);
